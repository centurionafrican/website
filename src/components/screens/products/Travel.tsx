    ...
    <section className="w-full relative bg-[#F8FAFC] py-4 sm:py-6 md:py-8 lg:py-12 overflow-hidden  flex items-center">
      ...
      <div className="w-full max-w-7xl mx-auto px-0 sm:px-0 lg:px-0 relative z-10">
        <ImageTextSection
          ...
          description={`
            <p>
              Travelling can be sensational, but can also reflect unforeseen risks.
              </p>
              <p>
              Therefore, Alliance Insurance Brokers, protects you against unexpected circumstances while you’re travelling abroad, including cancellations, unplanned medical expenses, lost luggage, flight accidents and other losses.
              </p>
            <h3>
              <b>
