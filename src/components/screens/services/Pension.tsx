  ...
  return (
    <section className="w-full relative bg-[#F8FAFC] py-4 sm:py-6 md:py-8 lg:pt-12 lg:pb-24 overflow-hidden  flex items-center">
      ...
      <div className="w-full max-w-7xl mx-auto px-0 sm:px-0 lg:px-0 relative z-10">
        <ImageTextSection
          title="Pensions consultancy"
          description="As a pension’s consultant, we can provide advice and information on retirement provision to other organizations and advise on the best form of pension’s provision for the organisation as a whole to provide to its employees."
          imageSrc="/services/retirement.jpg"
          imageAlt="Pensions Consulting / Managements"
          position="right"
        />
      </div>
    </section>
