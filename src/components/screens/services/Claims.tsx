    ...
    <section className="w-full relative bg-[#F8FAFC] py-4 sm:py-6 md:py-8 lg:py-12 overflow-hidden  flex items-center">
      ...
      <div className="w-full max-w-7xl mx-auto px-0 sm:px-0 lg:px-0 relative z-10">
        <ImageTextSection
          ...
          description="We advocate on your behalf with the insurance company to ensure that claims are adjusted properly and paid promptly. We will assist you with the resolution of all claims and will constantly communicate our progress and the status of the claim to you. "
          imageSrc="/services/claims.svg"
