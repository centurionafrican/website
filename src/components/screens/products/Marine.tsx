    ...
    <section className="w-full relative bg-[#F8FAFC] py-4 sm:py-6 md:py-8 lg:py-12 overflow-hidden  flex items-center">
      ...
      <div className="w-full max-w-7xl mx-auto px-0 sm:px-0 lg:px-0 relative z-10">
        <ImageTextSection
          ...
          description={`
            <p>
              At Alliance our seamless approach, experience and
              expertise are a perfect fit for your Marine insurance needs.
              Marine cargo insurance is a class of property insurance that
              insures property while in transit against loss or damage
              arising from perils associated with the navigation of the sea
              or air and subsequent land and inland waterways. 
            </p>
            <br />
            <p>
              We offer Insurance solutions for all kind of commodities and
              alternatives for transportation by sea or air.
            </p>`}
          imageSrc="/products/marine.svg"
          imageAlt="marine"
          position="left"
        />
      </div>
