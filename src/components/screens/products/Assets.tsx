    ...
    <section className="w-full relative bg-[#F8FAFC] py-4 sm:py-6 md:py-8 lg:py-12 overflow-hidden  flex items-center">
      ...
      <div className="w-full max-w-7xl mx-auto px-0 sm:px-0 lg:px-0 relative z-10">
        <ImageTextSection
          ...
          description={`
            <p>
              we have introduced risk management services
              as a value added service for our clients to help safeguard
              their businesses and operations. Insurance is one form of
              financing your risk, but there are other alternatives to
              explore.
            </p>
            <br />
            <p>
              General and specialized policies can help you enhance your
              coverage pool. Risk management provides a more holistic
              approach to risk and we have done so for some of the
              largest corporate companies in Rwanda. Contact us today
              to enable us showcase our abilities.
            </p>`}
          imageSrc="/products/asset.svg"
