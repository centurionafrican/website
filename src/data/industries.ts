    ...
    features: [
      {
        ...
        description: `The surveillance system, equipped with high-resolution cameras,
          can provide real-time, high-quality surveillance of airport
          facilities and other critical areas as well as motion detection
          and video analytics technology to trigger alarms and send alerts
          to security personnel. The cameras are equipped with night
          vision and thermal imaging capabilities to detect intruders in
      ...
      },
      {
        ...
        description: `The surveillance system Centurion provides uses advanced
            access control technology to restrict unauthorized access to the
            restricted areas as well as various checkpoints. The system
            provides secure access to authorized personnel unauthorized
      ...
      },
      {
        id: "perimeter-protection",
        title: "Perimeter Protection",
        description: `The surveillance system uses advanced
          perimeter protection technology to secure
          the airport and other facilities outer
          perimeter. The system provides secure
          fencing and barriers to prevent intruders from
          gaining access to the secure area.`,
        icon: "/cent.svg",
        buttons: ["Electric Fencing", "Barrier gates", "Electronic sensors"],
      },
      {
        ...
        description: `Advanced behavioral analytics software
            helps detect behavior that may indicate
            high-risk passengers or those with
            malicious intent.`,
        icon: "/cent.svg",
        buttons: [
          "Analyze",
          "Detects Potential threat",
          "Alert physical security",
        ],
      },
      {
        id: "cybersecurity",
        title: "Cybersecurity",
        description: `Airports and airlines rely heavily on technology
          to manage and operate their systems.
          Centurion helps protect this data from
      ...
      },
      {
        ...
        description: `Baggage screening is a critical part and
          complex process that requires a
          combination of technologies, processes,
          and trained personnel to ensure the safety
  ...
  "critical-infrastructure": {
    ...
    features: [
      ...
      },
      {
        ...
        description: `The surveillance system uses advanced
          perimeter protection technology to secure
          the critical infrastructure site's outer
          perimeter. The system provides secure
          fencing and barriers to prevent intruders from
          gaining access to the critical infrastructure
          site.`,
        icon: "/cent.svg",
        buttons: ["Electric Fencing", "Barrier Gates", "Electronic Sensors"],
      },
      {
        ...
        description: `The surveillance system includes fire
        prevention technology to keep the
        critical infrastructure site safe from
        fires. The system provides early warning
        and alerts for potential fires to prevent
        serious damage.`,
        icon: "/cent.svg",
        buttons: [
          "Fire Detection",
      ...
      },
      {
        ...
        description: `The Centurion surveillance system includes
          environmental monitoring technology to
          monitor and detect changes in the environment
          on and around the critical infrastructure site`,
        icon: "/cent.svg",
        buttons: [
      ...
      },
      {
        ...
        title: "Real-Time Analytics",
        description: `The surveillance system uses advanced
          real-time analytics technology to process
          and analyze the data collected by the
          system's sensors and cameras.`,
        icon: "/cent.svg",
        buttons: [
          "Real-Time Data Processing",
          "Statistical Analysis",
