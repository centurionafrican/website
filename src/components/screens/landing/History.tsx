...
const HistorySection = () => {
  const events: TimelineEvent[] = [
    {
      year: "2024",
      description: "Started process to incorporate Centurion Guinea and Centurion Qatar",
      position: "left"
    },
    {
      year: "2024",
    ...
    {
      year: "2022",
      description: "Incorporation of Centurion CatSystems in Rwanda as a sister company",
      position: "right"
    },
    {
      year: "2020",
      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-8">
        ...
        >
          <motion.h2 
            ...
            className="text-[#F26230] md:text-7xl text-5xl font-bold text-left"
          >
            A brief history
          </motion.h2>
          ...
          <motion.p
            variants={itemVariants}
            className="text-white text-lg max-w-7xl mx-auto mt-6 text-left"
          >
        ...
        >
          ...
          <div className="space-y-10 md:space-y-16 relative">
            ...
            <div className="h-[14px] w-[14px] rounded-full bg-[#F26230]"></div>
          </div>
                  <div className="ml-20">
                    <div className="bg-white py-3 px-5 mb-4 max-w-xs">
                      <p className="text-[#252932]">{event.description}</p>
                    </div>
                    <div className="inline-block bg-[#F26230] text-white font-medium py-1 px-4">
                      {event.year}
                    </div>
                  </div>
                </div>
