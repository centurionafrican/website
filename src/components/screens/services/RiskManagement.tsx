    ...
    <section className="w-full relative bg-[#F8FAFC] py-4 sm:py-6 md:py-8 lg:py-12 overflow-hidden  flex items-center">
      ...
      <div className="w-full max-w-7xl mx-auto px-0 sm:px-0 lg:px-0 relative z-10">
        <ImageTextSection
          ...
          description="We are very clear, and consistent, in keeping Risk Management as a primary consideration for our clients when reviewing their Insurance programme."
          imageSrc="/services/risq.svg"
