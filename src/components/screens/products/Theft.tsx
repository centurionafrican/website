  ...
  return (
    <section className="w-full relative bg-[#F8FAFC] py-4 sm:py-6 md:py-8 lg:py-12 overflow-hidden  flex items-center">
      ...
      <div className="w-full max-w-7xl mx-auto px-0 sm:px-0 lg:px-0 relative z-10">
        <ImageTextSection
          title="Burglary and Theft Insurance"
          description={`
            <p>
              Alliance Insurance Brokers, provides indemnity against loss or damage to property following forcible or violent entry or exit from insured premises.
            </p>
            <p>
              <b>Assets such as office equipment, stock in trade, furniture fixtures, and fittings are covered.</b>
            </p>
            `}
          imageSrc="/products/theft.jpg"
